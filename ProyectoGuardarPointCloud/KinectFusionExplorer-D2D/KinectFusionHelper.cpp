...
/// <returns>indicates success or failure</returns>
HRESULT WriteAsciiPlyMeshFile(INuiFusionColorMesh *mesh,int num, bool flipYZ, bool outputColor)
{
    HRESULT hr = S_OK;
    ...
    /*************************************************************************************************************************************/
    // Open File
    std::string filename("C:\\Users\\Usuario\\3D Objects\\PruebaFusion\\");
    //char file = (char)num;
    //char d = (char)num;
    //filename.append(&d);
