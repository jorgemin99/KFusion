    ...
    LPARAM lParam)
{
    ...
    if ((int)elapsed >= 3)
    {
        ...
        Matrix4 mth=m_processor.getTransform();
        filePoses.open("filePoses.txt", std::ios_base::app);//app -> append
        filePoses << "{ " << mth.M11 << ", " << mth.M12 << ", " << mth.M13 << ", " << mth.M14 <<"; ";
        filePoses << mth.M21 << ", " << mth.M22 << ", " << mth.M23 << ", " << mth.M24 << "; ";
        filePoses << mth.M31 << ", " << mth.M32 << ", " << mth.M33 << ", " << mth.M34 << "; ";
        filePoses << mth.M41 << ", " << mth.M42 << ", " << mth.M43 << ", " << mth.M44 << "} \n";
        filePoses.close();
...
HRESULT CKinectFusionExplorer::SaveMeshFile(INuiFusionColorMesh* pMesh)
{
    HRESULT hr = S_OK;
    hr = WriteAsciiPlyMeshFile(pMesh,numero+1, true, true);
    numero += 1;
    return hr;
}
...
void CKinectFusionExplorer::ProcessUI(WPARAM wParam, LPARAM)
{
    ...
    /***********************************************************************************************************************************************/
    /***********************************************************************************************************************************************/
    //Condicion de reseteo. Guardar nube de puntos + pose.
    /***********************************************************************************************************************************************/
    /***********************************************************************************************************************************************/
    /*if(primera==1){
        primera = 0;
