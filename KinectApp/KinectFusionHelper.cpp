...
HRESULT WriteAsciiPlyMeshFile2(INuiFusionColorMesh* mesh, int num, bool flipYZ, bool outputColor) {
    ...
    /*************************************************************************************************************************************/
    // Open File
    std::string filename("C:\\Users\\Usuario\\3D Objects\\PruebaFusionConHilos5\\");
...
HRESULT WriteAsciiObjMeshFile2(INuiFusionColorMesh* mesh, int num, bool flipYZ)
{
    HRESULT hr = S_OK;
    ...
    // Open File
    std::string filename("C:\\Users\\Usuario\\3D Objects\\PruebaFusionConHilos4\\");
    filename.append(std::to_string(num) + ".obj");
    FILE* meshFile = NULL;
    errno_t err = fopen_s(&meshFile, filename.c_str(), "wt");
